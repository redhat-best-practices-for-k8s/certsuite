...
func NewCommand() *cobra.Command {
	...
	runCmd.PersistentFlags().Bool("non-intrusive", false, "Run intrusive tests that may disrupt the test environment")
	...
	runCmd.PersistentFlags().String("certsuite-probe-image", "quay.io/redhat-best-practices-for-k8s/certsuite-probe:v0.0.15", "Certsuite probe image")
