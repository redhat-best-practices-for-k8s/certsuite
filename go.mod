...
require (
	...
	github.com/redhat-best-practices-for-k8s/privileged-daemonset v1.0.68
...
require (
	...
	github.com/redhat-best-practices-for-k8s/checks v0.0.3-0.20260318171651-27a300d4ddaa // indirect
