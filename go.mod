...
require (
	...
	github.com/test-network-function/test-network-function-claim v1.0.22
...
require (
	...
	github.com/operator-framework/operator-manifest-tools v0.3.0 // indirect
...
require (
	...
	github.com/test-network-function/privileged-daemonset v1.0.6
