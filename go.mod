...
replace (
	github.com/openshift/api => github.com/openshift/api v0.0.0-20251015135203-5d856d3e8354
	github.com/operator-framework/operator-lifecycle-manager => github.com/operator-framework/operator-lifecycle-manager v0.36.0
	github.com/redhat-openshift-ecosystem/openshift-preflight => github.com/redhat-openshift-ecosystem/openshift-preflight v0.0.0-20250812183411-436b6cd740f4
)
