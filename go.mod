...
require (
	...
	github.com/redhat-best-practices-for-k8s/checks v0.0.27
	github.com/redhat-best-practices-for-k8s/oct v0.0.64
...
require (
	...
	github.com/operator-framework/operator-registry v1.72.0 // indirect
...
replace (
	...
	github.com/redhat-openshift-ecosystem/openshift-preflight => github.com/redhat-openshift-ecosystem/openshift-preflight v0.0.0-20260526175412-8a0341d649c5
)
