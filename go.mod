...
require k8s.io/client-go v0.33.0
...
require (
	...
	github.com/redhat-best-practices-for-k8s/oct v0.0.38
	github.com/redhat-best-practices-for-k8s/privileged-daemonset v1.0.52
...
replace github.com/operator-framework/operator-lifecycle-manager => github.com/operator-framework/operator-lifecycle-manager v0.31.0
