...
require (
	...
	github.com/operator-framework/operator-manifest-tools v0.9.0 // indirect
	github.com/operator-framework/operator-registry v1.55.0 // indirect
...
require (
	...
	github.com/redhat-openshift-ecosystem/openshift-preflight v0.0.0-20250625185809-50cef555ed0b
...
replace github.com/redhat-openshift-ecosystem/openshift-preflight => github.com/redhat-openshift-ecosystem/openshift-preflight v0.0.0-20250625185809-50cef555ed0b

replace github.com/openshift/api => github.com/openshift/api v0.0.0-20250624181540-f9cb76628723

replace github.com/operator-framework/operator-lifecycle-manager => github.com/operator-framework/operator-lifecycle-manager v0.32.0
