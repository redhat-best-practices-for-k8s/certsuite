...
import (
	...
	"github.com/test-network-function/cnf-certification-test/tests/accesscontrol/namespace"
	"github.com/test-network-function/cnf-certification-test/tests/accesscontrol/resources"
	"github.com/test-network-function/cnf-certification-test/tests/accesscontrol/securitycontextcontainer"
	"github.com/test-network-function/cnf-certification-test/tests/common"
	"github.com/test-network-function/cnf-certification-test/tests/common/rbac"
	...
	"github.com/test-network-function/cnf-certification-test/tests/networking/services"
...
func isInstallModeMultiNamespace(installModes []v1alpha1.InstallMode) bool {
	for _, installMode := range installModes {
		if installMode.Type == v1alpha1.InstallModeTypeAllNamespaces {
			return true
		}
	}
	return false
