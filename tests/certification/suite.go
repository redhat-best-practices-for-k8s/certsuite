...
func LoadChecks() {
	...
	checksadapter.AddCheck(checksGroup, "affiliated-certification-helm-version", checksfn.CheckHelmVersion, &env,
		skipIfNoHelmChartReleasesFn)

	checksadapter.AddCheck(checksGroup, "affiliated-certification-operator-is-certified", checksfn.CheckOperatorCertified, &env,
		skipIfNoOperatorsFn)

	checksadapter.AddCheck(checksGroup, "affiliated-certification-helmchart-is-certified", checksfn.CheckHelmChartCertified, &env,
		skipIfNoHelmChartReleasesFn)

	checksadapter.AddCheck(checksGroup, "affiliated-certification-container-is-certified-digest", checksfn.CheckContainerCertified, &env,
