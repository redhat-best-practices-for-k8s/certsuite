...
const (
	...
	supportImageDef                  = "debug-partner:4.3.2"
)
...
func deployDaemonSet(namespace string) error {
	...
	_, err := k8sPrivilegedDs.CreateDaemonSetDummy(DaemonSetName, namespace, containerName, dsImage, matchLabels, debugPodsTimeout)
	if err != nil {
