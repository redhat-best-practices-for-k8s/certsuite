...
Property|Description
---|---
Test Case Name|isolated-cpu-pool-rt-scheduling-policy
Test Case Label|performance-isolated-cpu-pool-rt-scheduling-policy
Unique ID|http://test-network-function.com/testcases/performance/isolated-cpu-pool-rt-scheduling-policy
Version|v1.0.0
Description|http://test-network-function.com/testcases/performance/isolated-cpu-pool-rt-scheduling-policy Ensures that a workload running in an application-isolated exclusive CPU pool selects a RT CPU scheduling policy
Result Type|normative
...
Property|Description
---|---
Test Case Name|rt-apps-no-exec-probes
Test Case Label|performance-rt-apps-no-exec-probes
Unique ID|http://test-network-function.com/testcases/performance/rt-apps-no-exec-probes
Version|v1.0.0
Description|http://test-network-function.com/testcases/performance/rt-apps-no-exec-probes Ensures that if one container runs a real time application exec probes are not used
Result Type|normative
